...
type TestSuiteSQL struct {
	suite.Suite
	data []Log
	db   SqliteDB
}

func (suite *TestSuiteSQL) SetupSuite() {
...
func (suite *TestSuiteSQL) SetupTest() {
	suite.data = []Log{
		{
			Id:                          "user1",
			Message:                     "abcde",
...
func (suite *TestSuiteSQL) TearDownTest() {
	var logs []Log
	suite.db.db.DropTable(&logs)

}

func (suite *TestSuiteSQL) TearDownSuite() {
	suite.db.db.Close()
}

func TestSuiteSQLFunc(t *testing.T) {
	suite.Run(t, new(TestSuiteSQL))
}

func (suite *TestSuiteSQL) TestSqliteDB_Create1() {
...
func (suite *TestSuiteSQL) TestSqliteDB_Create2() {
	test := CreateLogTableTest{
		Name:   "create log 2",
		Input:  suite.data[1],
		Output: suite.data[1],
...
func (suite *TestSuiteSQL) TestSqliteDB_Get1() {
...
func (suite *TestSuiteSQL) TestSqliteDB_Get2() {
	test := GetLogsTableTest{
		Name:   "empty",
		Input:  3,
		Output: 3,
...
func (suite *TestSuiteSQL) TestSqliteDB_Get3() {
	test := GetLogsTableTest{
		Name:   "seven records",
		Input:  7,
		Output: 7,
...
func (suite *TestSuiteSQL) TestInSqliteDB_GetByUser1() {
...
func (suite *TestSuiteSQL) TestInSqliteDB_GetByUser2() {
	test := GetByUserTableTest{
		Name:   "user2 1 log",
		Input:  "user2",
		Output: 1,
...
func (suite *TestSuiteSQL) TestInSqliteDB_GetByUser3() {
	test := GetByUserTableTest{
		Name:   "no id",
		Input:  "",
		Output: 0,
...
func (suite *TestSuiteSQL) TestInSqliteDB_Update1() {
...
func (suite *TestSuiteSQL) TestInSqliteDB_Update2() {
	test := UpdateLogsTableTest{
		Name:    "update id 3",
		InputID: 3,
		InputLog: Log{
...
func (suite *TestSuiteSQL) TestInSqliteDB_Update3() {
	test := UpdateLogsTableTest{
